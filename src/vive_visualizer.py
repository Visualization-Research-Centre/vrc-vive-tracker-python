...
class ViveVisualizer:
    ...
    def update_canvas(self, blobs, trackers, radius):
        ...
        # draw connections
        self.draw_to_all_in_radius(connectors, radius=radius*width/16)
    ...
    def unique_connection(self, positions):
        ...
        for _ in range(number_trackers - 1):
            ...
            self.draw_connection(x_positions[current_index], y_positions[current_index],
    ...
    def unique_connection_w_tracing(self, positions):
        ...
        while end_list:
            ...
            if closest_end:
                ...
                self.draw_connection(current_start[0], current_start[1], closest_end[0], closest_end[1])
            ...
            for j, end in enumerate(positions):
                if i != j:
                    ...
                    if distance < nearest_distance:
                        ...
                        nearest_index = j
            if nearest_index != -1:
                self.draw_connection(start[0], start[1], positions[nearest_index][0], positions[nearest_index][1])
